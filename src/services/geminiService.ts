  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        FLUJO DE PREGUNTAS:
        1. Saludo: "Hola, soy el asistente de Hope. ¿Buscás una solución para hogar o para empresa/obra?"
        ...
        CIERRE:
        "Podés contactar a Exequiel por WhatsApp (+54 3496 55-7841) o al mail hopecontenedores@gmail.com para un presupuesto exacto."`,
      },
    });
